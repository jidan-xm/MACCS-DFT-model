...
# 提取分子指纹、DFT 特征和目标值
fingerprint_data = df[fingerprint_columns,dft_feature_columns].values
...
# 3. 数据分割
# ============================
X = np.hstack([fingerprint_data])  # 将分子指纹与 DFT 特征合并
...
# 输出到 Excel 文件
output_path = 'gbr_param_results.xlsx'
